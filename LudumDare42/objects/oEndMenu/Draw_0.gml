...
draw_text_transformed_color(150, room_height / 2,		"Dead Dogs: "	+ string(global.deadDogs), 0.75, 0.75, 0, col, col, col, col, 1);
draw_text_transformed_color(150, room_height / 2 + 15,	"RIP Good Boys: "	+ string(global.goodBoys), 0.75, 0.75, 0, col, col, col, col, 1);